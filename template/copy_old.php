...
<div style="width: 100%; float: left;"><div style="width: 5%; float: left;">Auswahl</div><div style="width: 10%; float: left;">Semester</div><div style="width: 40%; float: left;">Veranstaltungsname</div><div style="width: 40%; float: left;">Dateiordner mit Dateien f&uuml;r das Wiki</div></div>
<? foreach($vls as $v) : ?>
